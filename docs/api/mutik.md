...
|  --- | --- |
|  [createStore(initialState)](./mutik.createstore.md) | Create a Mutik <code>store</code> given some initial state. The <code>store</code> can be used in or out of React. |
|  [Provider({ children, store })](./mutik.provider.md) | Mutik context provider. |
|  [useSelector(selector)](./mutik.useselector.md) | React hook to subscribe to Mutik state. Must be called underneath a Mutik [Provider()](./mutik.provider.md)<!-- -->. |
...
|  --- | --- |
|  [Listener](./mutik.listener.md) | Callback listener |
|  [UpdaterFn](./mutik.updaterfn.md) | Mutik updater function |
